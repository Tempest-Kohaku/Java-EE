...
<body>
    ...
    <c:set var="doctor" value="${sessionScope.doctor}" />
    <c:set var="patientId" value="${param.patientId}" />

    <div class="container">
        <h1><i class="fas fa-prescription-bottle-alt icon"></i>Add Prescription</h1>
        <form action="AddPrescriptionServlet" method="post">
            <input type="hidden" name="patientId" value="${patientId}">
            <input type="hidden" name="doctorId" value="${doctor.id}">
            <div class="form-group">
                <label for="description">Prescription Details:</label>
